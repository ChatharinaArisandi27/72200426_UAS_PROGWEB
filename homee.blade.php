        ...
        <div class="row border">
            <div class="col-lg-3 border text-info py-5" >
                <div class="nav flex-column nav-pills" role="tablist" ariaorientation="vertical">
                    <a class="nav-link bg-info text-dark rounded-0 p-2 border  " href="/home">Home</a>
                    <a class="nav-link bg-light text-dark rounded-0 p-2 border active" href="/mahasiswa">Mahasiswa</a>
