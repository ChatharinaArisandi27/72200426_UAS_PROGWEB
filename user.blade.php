  ...
  <body> <br>
    <div class="container-fluid">
        ...
        <div class="row border">
            ...
            <a name="" class="btn btn-primary" href="/user/form" role="button"><i class="bi bi-file-earmark-plus"></i> ADD USER</a>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> {{$u->nama}}</td>
                            <td>
                              <a href="/user/edituser/{{ $u -> id }}" class="btb btn-outline-success"><i class="bi bi-pencil-square"></i></a>
                              <a href="/user/deleteuser/{{ $u -> id }}" class="btb btn-outline-danger" onclick="return confirm('Yakin akan menghapus data ini ?')"><i class="bi bi-trash3"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
